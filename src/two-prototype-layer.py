...
if __name__ == "__main__":
    ...
    out_dir = "/big/xw384/schoolwork/NLP+DEEP LEARNING/Project/CASCADE/src/runs/two_prototype_layer-15_protos/"
    ...
    for epoch in range(args.num_epochs):
        ...
        for i, inputs in tqdm(enumerate(train_loader)):
            ...
            with tf.GradientTape() as tape:
                ...
                # # the third loss term
                # div_loss = tight_pos_sigmoid_offset(min_d2_dist, 1) + 1e-8
                # loss = acc_loss +0.1*div_loss
                # gradients = tape.gradient(acc_loss, ProtoCNN.trainable_weights)
        ...
        for x_batch, author_batch, topic_batch, y_batch in tqdm(dev_loader):
            ...
            # predictions, _, protos= ProtoCNN([x_batch, author_batch, topic_batch], training=False)
        ...
        with open(out_dir+'losses.pkl', 'wb') as file:
            pickle.dump((train_loss, dev_loss, train_acc, dev_acc,test_acc ), file)
