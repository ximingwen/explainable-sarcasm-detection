...
class TextCNN(tf.keras.Model):
    ...
    def __init__(
        self, sequence_length, num_classes, embedding_model, user_embeddings, topic_embeddings, embedding_size, filter_sizes, num_filters, l2_reg_lambda, dropout_keep_prob, k_protos, vect_size):
    ...
    def call(self, inputs):
        ...
        x = self.embedding.encode(input_content)
        ...
        res_vect = self.res_distance_layer(full_distances)
        ...
        user_vect = self.user_distance_layer(full_distances)
